...
function Button({ children, disabled, to, type }) {
    ...
    const styles = {
        ...
        secondary:
            "inline-block rounded-full border-2 border-stone-300 font-semibold uppercase  text-stone-400  tracking-wide  hover:bg-stone-300 transition-colors duration-300 focus:outline-none hover:text-stone-800 focus:ring focus:ring-stone-300 focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5 text-sm",
    }
